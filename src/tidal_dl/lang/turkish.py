...
class LangTurkish(object):
    ...
    SETTING_ADD_EXPLICIT_TAG = (
        "'Küfürlü' etiketi eklensin:"
    )
    SETTING_ADD_HYPHEN = (
        "Boşluk yerine '-' eklensin:"
    )
    SETTING_ADD_YEAR = "Yıl eklensin:"
    SETTING_USE_TRACK_NUM = (
        "Artist numarası eklensin:"
    )
