...
class LangNorwegian(object):
    ...
    SETTING_ONLY_M4A = (
        "Konverter MP4 til M4A"
    )
    SETTING_ADD_EXPLICIT_TAG = (
        "Legg til eksplisitt tag"
    )
    SETTING_ADD_HYPHEN = (
        "Legg til bindestrek"
    )
    SETTING_ADD_YEAR = (
        "Legg til år før albummappenavn"
    )
    ...
    SETTING_CHECK_EXIST = (
        "Kontroller eksistens"
    )
    SETTING_ARTIST_BEFORE_TITLE = (
        "Artistnavn før spornummer"
    )
