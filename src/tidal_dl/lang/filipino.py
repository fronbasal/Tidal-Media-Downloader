...
class LangFilipino(object):
    ...
    SETTING_ONLY_M4A = (
        "I-convert ang mp4 bilang m4a"
    )
    SETTING_ADD_EXPLICIT_TAG = (
        "Lagyan ng explicit tag"
    )
    SETTING_ADD_HYPHEN = (
        "Lagyan ng hyphen"
    )
    ...
    SETTING_USE_TRACK_NUM = (
        "Lagyan ng bilang ng user track"
    )
    ...
    SETTING_ADD_LRC_FILE = (
        "Save timed lyrics (.lrc file)"
    )
    ...
    CHANGE_SHOW_PROGRESS = (
        "Show progress('0'-No,'1'-Yes):"
    )
    CHANGE_SHOW_TRACKINFO = "Show track info('0'-No,'1'-Yes):"
    CHANGE_SAVE_ALBUM_INFO = "Save AlbumInfo.txt('0'-No,'1'-Yes):"
    CHANGE_DOWNLOAD_VIDEOS = "Download videos (when downloading playlists, albums, mixes)('0'-No,'1'-Yes):"
    CHANGE_ADD_LYRICS = (
        "Add lyrics('0'-No,'1'-Yes):"
    )
