...
class LangVietnamese(object):
    ...
    SETTING_LYRICS_SERVER_PROXY = (
        "Máy chủ proxy cho lyrics"
    )
    SETTING_ADD_LRC_FILE = (
        "Lưu timed lyrics (tệp .lrc)"
    )
    ...
    AUTH_TIMEOUT = (
        "Đã vượt quá thời gian chờ."
    )

    MSG_VALID_ACCESSTOKEN = (
        "AccessToken vẫn tốt trong {}."
    )
