...
class LangSpanish(object):
    ...
    MODEL_ARTIST_PROPERTY = (
        "PROPIEDAD-DE-ARTISTA"
    )
    MODEL_PLAYLIST_PROPERTY = (
        "PROPIEDAD-DE-PLAYLIST"
    )
