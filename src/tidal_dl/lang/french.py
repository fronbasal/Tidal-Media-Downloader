...
class LangFrench(object):
    ...
    CHOICE_DOWNLOAD_BY_URL = (
        "Téléchargement par url ou id"
    )
    CHOICE_LOGOUT = "Déconnexion"
    CHOICE_APIKEY = (
        "Choisir la clé d'API"
    )
