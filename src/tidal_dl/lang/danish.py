...
class LangDanish(object):
    ...
    SETTING_ADD_EXPLICIT_TAG = (
        "Tilføj eksplicit tag"
    )
    SETTING_ADD_HYPHEN = (
        "Tilføj bindestreg"
    )
    SETTING_ADD_YEAR = (
        "Tilføj år før album mappe"
    )
