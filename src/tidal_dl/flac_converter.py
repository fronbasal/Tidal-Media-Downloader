...
def extract_flac_with_metadata(
    mp4_flac_path: str,
    ...
    try:
        ...
        debug(
            f"Extracting FLAC audio from {mp4_flac_path}"
        )
        ...
        debug(
            f"Successfully converted {mp4_flac_path} to {output_path}"
        )
        return output_path
