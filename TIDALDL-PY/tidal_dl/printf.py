...
|__  $$__/|__/      | $$          | $$              | $$| $$
   ...
   |__/   |__/ \_______/ \_______/|__/         \_______/|__/
       ...
       https://github.com/fronbasal/Tidal-Media-Downloader
...
class Printf(object):
    ...
    def usage():
        ...
        tb = Printf.__gettable__(
            ...
            [
                ...
                ["-j or --json", "output item json (needs -l)"],
    ...
    def settings():
        data = SETTINGS
        tb = Printf.__gettable__(
            [LANG.select.SETTING, LANG.select.VALUE],
            [
                ...
                [
                    ...
                    f"[{data.apiKeyIndex}]"
                    + apiKey.getItem(data.apiKeyIndex)["formats"],
                ],
    ...
    def choices():
        print("====================================================")
        tb = Printf.__gettable__(
            [LANG.select.CHOICE, LANG.select.FUNCTION],
            [
                [
                    aigpy.cmd.green(LANG.select.CHOICE_ENTER + " '0':"),
                    LANG.select.CHOICE_EXIT,
                ],
                [
                    aigpy.cmd.green(LANG.select.CHOICE_ENTER + " '1':"),
                    LANG.select.CHOICE_LOGIN,
                ],
                [
                    aigpy.cmd.green(LANG.select.CHOICE_ENTER + " '2':"),
                    LANG.select.CHOICE_LOGOUT,
                ],
                [
                    aigpy.cmd.green(LANG.select.CHOICE_ENTER + " '3':"),
                    LANG.select.CHOICE_SET_ACCESS_TOKEN,
                ],
                [
                    aigpy.cmd.green(LANG.select.CHOICE_ENTER + " '4':"),
                    LANG.select.CHOICE_SETTINGS + "-Path",
                ],
                [
                    aigpy.cmd.green(LANG.select.CHOICE_ENTER + " '5':"),
                    LANG.select.CHOICE_SETTINGS + "-Quality",
                ],
                [
                    aigpy.cmd.green(LANG.select.CHOICE_ENTER + " '6':"),
                    LANG.select.CHOICE_SETTINGS + "-Else",
                ],
                [
                    aigpy.cmd.green(LANG.select.CHOICE_ENTER + " '7':"),
                    LANG.select.CHOICE_APIKEY,
                ],
                [
                    aigpy.cmd.green(LANG.select.CHOICE_ENTER_URLID),
    ...
    def album(data: Album):
        tb = Printf.__gettable__(
            [LANG.select.MODEL_ALBUM_PROPERTY, LANG.select.VALUE],
            [
    ...
    def track(data: Track, stream: StreamUrl = None):
        tb = Printf.__gettable__(
            [LANG.select.MODEL_TRACK_PROPERTY, LANG.select.VALUE],
            [
                [LANG.select.MODEL_TITLE, data.title],
                ["ID", data.id],
    ...
    def video(data: Video, stream: VideoStreamUrl = None):
        tb = Printf.__gettable__(
            [LANG.select.MODEL_VIDEO_PROPERTY, LANG.select.VALUE],
            [
                [LANG.select.MODEL_TITLE, data.title],
                [
                    LANG.select.MODEL_ALBUM,
                    data.album.title if data.album != None else None,
                ],
                [LANG.select.MODEL_VERSION, data.version],
                [LANG.select.MODEL_EXPLICIT, data.explicit],
                ["Max-Q", data.quality],
    ...
    def artist(data: Artist, num):
        tb = Printf.__gettable__(
            [LANG.select.MODEL_ARTIST_PROPERTY, LANG.select.VALUE],
            [
    ...
    def playlist(data):
        tb = Printf.__gettable__(
            [LANG.select.MODEL_PLAYLIST_PROPERTY, LANG.select.VALUE],
            [
                [LANG.select.MODEL_TITLE, data.title],
                [LANG.select.MODEL_TRACK_NUMBER, data.numberOfTracks],
                [LANG.select.MODEL_VIDEO_NUMBER, data.numberOfVideos],
